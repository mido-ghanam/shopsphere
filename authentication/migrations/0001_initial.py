# Generated by Django 5.2.1 on 2025-06-22 00:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_user_username', models.TextField(max_length=17, unique=True)),
                ('phone_number', models.CharField(max_length=17, unique=True, validators=[django.core.validators.RegexValidator(message="Phone must be like '+201000000010'", regex='^\\+?1?\\d{9,15}$')])),
